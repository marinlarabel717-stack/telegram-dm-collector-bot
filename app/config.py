...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        emoji_upload_id=os.getenv("EMOJI_UPLOAD_ID", DEFAULT_EMOJI_IDS["upload"]),
        emoji_waiting_id=os.getenv("EMOJI_WAITING_ID", DEFAULT_EMOJI_IDS["waiting"]),
        emoji_ok_id=os.getenv("EMOJI_OK_ID", DEFAULT_EMOJI_IDS["ok"]),
